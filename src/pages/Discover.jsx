...
function Discover() {
  ...
  return (
    <div style={backgroundStyles} className="h-screen relative card-container">
      ...
      <div className="container mx-auto">
        <div className="p-6 bg-transparent mt-34">
          ...
          {/* Content */}
          <div className=" flex flex-wrap 2xl:justify-start items-center xl:justify-start gap-[30px] ">
            {/* cards */}
            {renderPlaces}
          </div>
        </div>
